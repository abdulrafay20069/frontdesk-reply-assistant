...
function NewInquiryDrawer({ open, onClose }: Props) {
  ...
  return (
    <>
      ...
      {/* Panel */}
      <div
        className={`fixed z-50 bg-surface transition-transform duration-200 ${
          isMobile
      ...
      >
        {isMobile && (
          <div className="flex justify-center pt-2 pb-1">
            <div className="w-8 h-1 rounded-full bg-[#2e2e36]" />
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          <div>
            <label className="block text-sm font-medium text-text-primary mb-1.5">Customer name</label>
            <input
              value={customerName}
          ...
          <div>
            <label className="block text-sm font-medium text-text-primary mb-1.5">Customer email</label>
            <input
              type="email"
              value={customerEmail}
          ...
          <div>
            <label className="block text-sm font-medium text-text-primary mb-1.5">Channel</label>
          ...
          <button
            ...
            className="w-full py-2.5 bg-accent hover:bg-accent-hover disabled:opacity-60 text-white text-sm font-medium rounded-lg transition-colors"
          >
